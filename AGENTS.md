...
1. **국민의례 약식 절차 표준 준수 (대통령훈령 제438호 국민의례 규정 반영)**:
   - 야외 축제, 체육대회, 걷기행사 등에서 국민의례를 약식 절차로 진행할 때는 **'국기에 대한 경례'** 만 엄숙히 실시합니다.
   - **금지 멘트 (절대 사용 금지)**: 사회자가 *"애국가 제창 및 순국선열에 대한 묵념은 생략하겠습니다"*, *"애국가 제창 등 이하 생략하겠습니다"* 등의 생략 표현을 발언하는 것은 국가상징의 품격을 저해하므로 **규정상 엄격히 금지**합니다.
   - **표준 사회자 시나리오/대본 준거**:
     * 안내: "다음은 국민의례가 있겠습니다. 참석자 여러분께서는 모두 자리에서 일어나 단상의 국기를 향해 주시기 바랍니다."
     * 구호: "국기에 대하여 경례!" (경례곡 연주 또는 맹세문 낭송)
     * 구호: "바로!"
     * 전환: "(생략 멘트 일체 없이 곧바로 다음 식순으로 자연스럽게 전환)" -> "모두 자리에 정돈해(앉아) 주시기 바랍니다. 다음은 오늘 행사를 빛내주시기 위해 참석하신 내빈 여러분을 소개해 올리겠습니다."
2. **정식 절차와 약식 절차의 엄격한 구분**:
   - 정식 절차: 국기에 대한 경례 -> 애국가 제창(1~4절 또는 1절) -> 순국선열과 호국영령에 대한 묵념
   - 약식 절차: 국기에 대한 경례(경례곡 연주 또는 구호) -> 착석 및 내빈소개 직결
...
- **동기화된 마일스톤:**
  ...
  - 그 외 과거 누적 마일스톤 총 201건 통합 요약 (초기 ~ 2026-09-04 이전 패치 내역)
