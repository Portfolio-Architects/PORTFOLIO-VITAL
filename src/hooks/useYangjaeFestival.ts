...
export const YANGJAE_FALLBACK_DATA: FestivalData = {
  "meta": {
    ...
    "targetAudience": "강남구민 1,000여명 (사전 접수 800명 + 체육회 200~250명)",
    "programStructure": [
      "건강 걷기 체험 프로그램(4km, 구청장배 걷기대회 연계)",
  ...
  "milestones": [
    {
      ...
      "details": [
        ...
        "[완료][26.9.7.][참여:과장님, 지영팀장님, 오창선] 강남구체육회(걷기협회) 구청장배 걷기대회(200~250명) 공동개최 협의 : 10.31. 동시 개최를 통한 대구민 참여 시너지 극대화 및 장소 일원화",
        "[예정][9.8.(화)] 전 부서 행사 알림 : 행사 포스터 시안 확정 이후",
    ...
    },
    {
      ...
      "details": [
        ...
        "[예정][09:02~09:04] 국민의례 (2분) : 국기에 대한 경례(약식) ※ 의전주의: 약식 진행 시 '애국가 제창 등 이하 생략' 멘트 금지, 경례 후 곧바로 다음 순서로 전환",
    ...
    },
    {
      ...
      "details": [
        ...
        "[진행] 보건소 전 부서 참여자 모객 협업 체계 가동 : 보건행정팀 및 민원서비스팀 구민 홍보·동원 및 유관 단체 초청 검토",
        "[예정][참여:과장님] 인근 동 주민센터(개포·일원·대치·도곡 등) 동장님 협조 요청 : 관내 직능단체 및 주민 참여 적극 독려",
    ...
    },
    {
      ...
      "cooperationDepts": [],
      "details": [
        "[예정] 보건소 전 직원(금연단속원 포함) 행사 현장 안전관리 및 구민 안내 전원 배치 계획 수립 (대체휴무 부여)",
        "[예정] 1,000명 이상 대규모 인파 대비 안전관리계획 심의 및 응급의료 지원 동선 구축"
      ]
    },
    {
      "id": 8,
